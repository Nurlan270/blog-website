            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group col">
                        <input name="img" type="file" value="<?= $img ?>" class="form-control" id="inputGroupFile02">
                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                    </div>
                    <select name="topic" class="form-select" aria-label="Default select example">
                        <option value="0" selected>Topics ▤</option>
                        <?php
                        $topics = selectFromTable('topics', ['id', 'name'], order_by_desc: true);
                    ...
                    <div class="col col-6">
                        <button name="create-post" class="btn btn-primary" type="submit">Create post ↥</button>
                    </div>
                </form>
            </div>
        </div>
